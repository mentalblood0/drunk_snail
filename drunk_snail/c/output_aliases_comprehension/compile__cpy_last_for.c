...
#define compile__cpy_last_for(param_name_start, param_name_end) {\
	\
	addTabs(&result_end, tabs_number);\
	compile__cpy_last_for_l1(param_name_start, param_name_end);\
	\
	addTabs(&result_end, tabs_number);\
	compile__cpy_one('\t');\
	...
	\
	addTabs(&result_end, tabs_number);\
	compile__cpy_last_for_l3(param_name_start, param_name_end);\
	\
	addTabs(&result_end, tabs_number);\
	compile__cpy_one('\t');\
	compile__cpy_print_left_part();\
	...
	\
	addTabs(&result_end, tabs_number);\
	compile__cpy_last_for_l5();\
	\
	addTabs(&result_end, tabs_number);\
	compile__cpy_last_for_l6(param_name_start, param_name_end);\
	\
	addTabs(&result_end, tabs_number);\
    compile__cpy_one('\t');\
    compile__cpy_one('\t');\
