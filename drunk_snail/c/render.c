...
#define render__empty(target, LINE, LINE_length) {\
	...
	for (i = 0; i < depth; i++) {		memcpy(*target, (*other)[i].left.start, (*other)[i].left.length); *target += (*other)[i].left.length;\
	}\
...
/* #line 306 "compileComprehension.c" */
	{
	if ( p == pe )
		goto _test_eof;
	switch ( cs )
...
st0:
	if ( ++p == pe )
		goto _test_eof0;
case 0:
/* #line 347 "compileComprehension.c" */
	switch( (*p) ) {
		case 10: goto tr1;
		case 60: goto tr2;
	}
...
st1:
	if ( ++p == pe )
		goto _test_eof1;
case 1:
/* #line 365 "compileComprehension.c" */
	switch( (*p) ) {
		case 10: goto tr4;
		case 60: goto tr5;
	}
...
st2:
	if ( ++p == pe )
		goto _test_eof2;
case 2:
/* #line 400 "compileComprehension.c" */
	switch( (*p) ) {
		case 10: goto tr4;
		case 33: goto st3;
		case 60: goto tr5;
...
st6:
	if ( ++p == pe )
		goto _test_eof6;
case 6:
/* #line 458 "compileComprehension.c" */
	switch( (*p) ) {
		case 10: goto tr4;
		case 60: goto tr5;
		case 111: goto st7;
...
st16:
	if ( ++p == pe )
		goto _test_eof16;
case 16:
/* #line 592 "compileComprehension.c" */
	switch( (*p) ) {
		case 10: goto tr4;
		case 32: goto tr24;
		case 45: goto tr25;
...
st17:
	if ( ++p == pe )
		goto _test_eof17;
case 17:
/* #line 617 "compileComprehension.c" */
	switch( (*p) ) {
		case 10: goto tr4;
		case 32: goto st17;
		case 45: goto st18;
...
/* #line 293 "compileComprehension_preprocessed.rl" */
	...
	break;
/* #line 946 "compileComprehension.c" */
	}
	}
