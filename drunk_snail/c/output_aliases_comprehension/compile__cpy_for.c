...
char *compile__for_end_optional_strings[11] = {
	"for ",
	" in ([] if ((not ",
	") or (not '",
	"' in ",
...
int compile__for_end_optional_lengths[11] = {4, 17, 11, 5, 9, 2, 11, 2, 18, 2, 6};

#define compile__for_end_optional_memcpy(i) compile__memcpy(compile__for_end_optional_strings[i], compile__for_end_optional_strings[i] + compile__for_end_optional_lengths[i]);

#define compile__cpy_for_end_optional(param_name_start, param_name_end) {\
	compile__for_end_optional_memcpy(0); compile__memcpy(param_name_start, param_name_end);\
	compile__for_end_optional_memcpy(1); compile__memcpy(template_name, template_name_end);\
	compile__for_end_optional_memcpy(2); compile__memcpy(param_name_start, param_name_end);\
	compile__for_end_optional_memcpy(3); compile__memcpy(template_name, template_name_end);\
	compile__for_end_optional_memcpy(4); compile__memcpy(template_name, template_name_end);\
	compile__for_end_optional_memcpy(5); compile__memcpy(param_name_start, param_name_end);\
	compile__for_end_optional_memcpy(6); compile__memcpy(template_name, template_name_end);\
	compile__for_end_optional_memcpy(7); compile__memcpy(param_name_start, param_name_end);\
	compile__for_end_optional_memcpy(8); compile__memcpy(template_name, template_name_end);\
	compile__for_end_optional_memcpy(9); compile__memcpy(param_name_start, param_name_end);\
	compile__for_end_optional_memcpy(10);\
}